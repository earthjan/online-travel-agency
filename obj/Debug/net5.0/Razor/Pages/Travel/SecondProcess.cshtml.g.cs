#pragma checksum "C:\Users\Earth Jan\Documents\Git\Repos\online-travel-agency\Pages\Travel\SecondProcess.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "bf9c2421261aaf63c4fd5e0962c0b9de68050bd7"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"bf9c2421261aaf63c4fd5e0962c0b9de68050bd7", @"/Pages/Travel/SecondProcess.cshtml")]
        ...
        <div class=""row row-cols-1 gy-4 row-cols-md-2 justify-content-lg-start"">
            ...
            WriteLiteral(@"""col d-flex justify-content-center"">
                                    <button class=""btn border border-secondary rounded-pill px-4 px-md-2""
                                        ...
                                        <img src=""icons/Passenger numbers.png"">
                                        <span class=""px-sm-1"" id=""passengerNumbersValue"">0</span>
                                        <img src=""icons/Bags.png"">
            ...
            WriteLiteral(@"              <span
                    ...
                    <!-- Filter by -->
                    <section class=""border border rou");
            WriteLiteral(@"nded-3 d-flex align-items-center mt-3 py-2 w-px-md-350"">
                        <div class=""container-fluid"">
            ...
            WriteLiteral(@"                      </div>
                            ...
                            <div class=""col col-lg-3"">
                                <div class=""row row-cols-2 h-100 row-cols-lg-1 flex-lg-column"">
                                    ...
                                    <div class=""col d-flex justify-content-center"">
                                        <button
                                            class=""btn border rounded bg-secondary-cs text-white flex-fil");
            WriteLiteral(@"l"">
                                            Book
                                        </button>
                                    </div>
