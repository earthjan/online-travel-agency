#pragma checksum "C:\Users\Earth Jan\Documents\Git\Repos\online-travel-agency\Pages\Travel\SecondProcess.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "59c384d6a29e36f8245f98cf6fdbe1a46e82cb01"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"59c384d6a29e36f8245f98cf6fdbe1a46e82cb01", @"/Pages/Travel/SecondProcess.cshtml")]
        ...
        <div class=""col col-lg-5"">
                        ...
                        <div class=""row row-cols-1 gy-2"">
                            ...
                            <div class=""col"">
                                <select class=""form-select border-0"">
                                    <opt");
            WriteLiteral(@"ion selected>Return</option>
                            ...
                            <div class=""col d-flex justify-content-center"">
                                <button class=""btn border border-secondar");
            WriteLiteral(@"y rounded-pill px-4 px-md-2""
            ...
            WriteLiteral(@"t="""">
                        ...
                        <div class=""row row-cols-1 gy-2"">
                            <!-- Departure schedule -->
                            <div class=""col"">
                                <div class=""input-group flex-nowrap justify-conten");
            WriteLiteral(@"t-center"">
                                    ...
                                    <input class=""border-start-0 border-1 border-secondary rounded-end bg-light w-100""
                            ...
                            <div class=""col"">
                                <div class=""input-group flex-nowrap justify-content-center"">
                                    ...
                                    <input class=""border-start-0 border-1 border-secondary rounded-end bg-light w-100""
                                    ");
            WriteLiteral(@"    type=""datetime-local"" id=""return-datetime"">
                                </div>
                            </div>
                            <div class=""col d-flex justify-content-center"">
                ...
                <section class=""border border rounded-3 d-flex align-items-center mt-3 py-2 w-px-md-350"">
                    <div class=""container-fluid"">
                        <div class=""row row-cols-1"">
                            ...
                            <!-- By price -->
                ");
            WriteLiteral(@"            <button class=""col btn d-flex justify-content-between border-bottom"">
                                <span>Price</span>
                ...
                <!-- Advertisement -->
                <section class=""border rounded-3 bg-l");
            WriteLiteral(@"ight w-px-md-350 mt-3"" style=""height: 350px;"">
                    <div class=""container-fluid"">
                        advertisement
                    </div>
                </section>
...
");
#nullable restore
#line 147 "C:\Users\Earth Jan\Documents\Git\Repos\online-travel-agency\Pages\Travel\SecondProcess.cshtml"
                 for (int a = 0; a <= 3; a++)
                {
 ...
 ");
  ...
  ");
       ...
       ");
            ...
            WriteLiteral("   </div>\r\n                        </div>\r\n                    </div>\r\n");
#nullable restore
#line 309 "C:\Users\Earth Jan\Documents\Git\Repos\online-travel-agency\Pages\Travel\SecondProcess.cshtml"
                }
        ...
        <div class=""modal-content"">
            ...
            <div class=""modal-body"">
                ...
                <div class=""row justify-content-sm-center border py-2"">
                    ...
                    <div class=""col-10 col-sm-2 d-flex");
            ...
            WriteLiteral(@"tent-sm-center border my-2 py-2"">
                    <div class=""col-2 d-flex justify-content-center align-items-center"">
                    ...
                    <div class=""col-4 col-sm-auto d-flex justify-");
            WriteLiteral(@"content-start justify-content-sm-start"">
                        <button class=""btn border bg-light rounded"" style=""width: 45px;""> + </button>
                    </div>
                </div>
                <!-- Infant -->
                <div class=""row justify-content-sm-center border py-2"">
                    ...
                    <div class=""col-4 col-sm-auto d-flex justify-content-end justify-content-sm-end"">
                        <button class=""btn border bg-light rounded"" sty");
            WriteLiteral(@"le=""width: 45px;""> - </button>
                    </div>
                    <div class=""col-4 col-sm-2"">
                        <input type=""number"" class=""form-control"">
                    </div>
    ...
    ");
            WriteLiteral(@"                </div>
                ...
                <div class=""row justify-content-sm-center border mt-2 py-2"">
                    ...
                    <div class=""col-10 col-sm-2 d-fl");
