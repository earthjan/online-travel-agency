...
CREATE TABLE `booked_passenger` (
  ...
  PRIMARY KEY (`booked_ID`,`passenger_ID`)
...
LOCK TABLES `booked_passenger` WRITE;
/*!40000 ALTER TABLE `booked_passenger` DISABLE KEYS */;
/*!40000 ALTER TABLE `booked_passenger` ENABLE KEYS */;
UNLOCK TABLES;
